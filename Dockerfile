...
RUN conda create -qy -p /usr/local \
        ...
        && curl -sL https://github.com/kids-first/kf-mskcc-vcf2mafv${MAF_VERSION}.tar.gz -o v${MAF_VERSION}.tar.gz && tar -xzf v${MAF_VERSION}.tar.gz && rm v${MAF_VERSION}.tar.gz && mv vcf2maf-${MAF_VERSION} vcf2maf
